...
import (
	...
	"github.com/furya-official/furymod/modules/record/client/cli"
...
// RegisterLegacyAminoCodec registers the record module's types on the LegacyAmino codec.
func (AppModuleBasic) RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	types.RegisterLegacyAminoCodec(cdc)
}

// DefaultGenesis returns default genesis state as raw bytes for the record
// module.
...
// GetTxCmd returns the root tx command for the record module.
func (AppModuleBasic) GetTxCmd() *cobra.Command {
	return cli.NewTxCmd()
}

// GetQueryCmd returns no root query command for the record module.
func (AppModuleBasic) GetQueryCmd() *cobra.Command {
	return cli.GetQueryCmd()
}

// RegisterInterfaces registers interfaces and implementations of the record module.
...
// ExportGenesis returns the exported genesis state as raw bytes for the record module.
...
// EndBlock returns the end blocker for the record module. It returns no validator updates.
...
// WeightedOperations returns the all the record module operations with their respective weights.
